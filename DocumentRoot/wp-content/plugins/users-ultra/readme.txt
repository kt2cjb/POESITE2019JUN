...
<strong>New reCaptcha add-on</strong><br>

You can download the new reCaptcha add-on <a href="https://wordpress.org/plugins/users-ultra-pro-recaptcha/"><strong>here </strong></a>
...
= 1.5.97(05-08-2015) =
* Improvement - IMPORTANT: Update your plugin ASAP. We have implemented some tweaks. If you're having issues you can just deaactivate it via ftp and upload the new version.
* New Feature -reCaptcha updated.


= 1.5.96(05-07-2015) =
* Improvement - First Stage of the new UU 2.0. We've been working over the past 5 months in order to improve UU.
This is the first version which is the first stage. We will be releasing a new version within 72 hours which will include the new reCaptcha and many other improvements.

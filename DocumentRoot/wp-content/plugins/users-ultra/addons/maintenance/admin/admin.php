<?php
class UsersUltraMaintenanceLite {
	...
	function __construct() {
		...
		$this->plugin_data = get_plugin_data( uultra_maintenance_path_lite . 'index.php', false, false);
	...
	function add_styles(){
		...
		wp_register_script( 'uultra_maintenance_js', uultra_maintenance_url_lite . 'admin/scripts/admin.js', array( 
			'jquery'
		) );
		wp_enqueue_script( 'uultra_maintenance_js' );
	
		wp_register_style('uultra_maintenance_css', uultra_maintenance_url_lite . 'admin/css/admin.css');
	...
	function get_tab_content() {
		...
		if( strstr($screen->id, $this->subslug ) ) {
			...
			require_once uultra_maintenance_path_lite.'admin/panels/'.$tab.'.php';
		}
	}
...
$uultra_maintenance = new UsersUltraMaintenanceLite();
...
class XooSocialLite
{
	...
	public function check_if_sent($friend_id) 
	{
		...
		$sql = "SELECT friend_id FROM " . $wpdb->prefix . "usersultra_friends  WHERE friend_receiver_id  = '".(int)$friend_id."' AND  friend_sender_user_id = '$logged_user_id'	 ";	 

...
class XooUserLoginLite {
	...
	******************************************/
	function get_instagram_auth_url() {
		...
		require_once(xoousers_lite_path."libs/instagram/instagram.class.php");
	...
	function load_twitter()
	{
		...
		
		{
			...
			if (!class_exists('TwitterOAuth'))
			{
				...
				require_once(xoousers_lite_path."libs/twitterapi/twitteroauth.php");
			}			
	...
	******************************************/
	...
	public function handle_social_facebook() 
	{
		...
		//require_once(xoousers_lite_path."libs/fbapi/src/facebook.php");

<?php
class XooUserAdminShortCodeLite
{
	...
	function respo_add_shortcode_button() 
	{
		...
		if ( get_user_option('rich_editing') == 'true') :
			...
			wp_enqueue_script( 'editor_plugin_short_options', xoousers_lite_url.'/admin/scripts/editor_plugin_short_options.js', array( 'jquery' ),'5.6.0',true);
	...
	{			
		...
		$plugin_array['USERSULTRAShortcodes'] = xoousers_lite_url . '/admin/scripts/editor_plugin.js';
		return $plugin_array;
...
$key = "adminshortcode";
$this->{$key} = new XooUserAdminShortCodeLite()
?>
	...
	******************************************/
	public function show_public_profile($atts)
	{
		...
		if($user_id>0 && $display)
		{
			...
			//get template
			require_once(xoousers_lite_path.'/templates/'.xoousers_lite_template."/".$template.".php");			
 ...
 $html .='</div>';
	...
	public function get_user_country_flag($user_id)
	{
		...
		{	
			...
			$isocode  = xoousers_lite_url."libs/flags/24/".$isocode.".png";					

 ...
 <h1><?php _e('Welcome to Users Ultra Lite!','xoousers'); ?></h1>
        ...
        <div class="user-ultra-sect ">      
          ...
          <div class="statblock-social user-ultra-rounded">                 
                    ...
                    <h3>Facebook </h3>
                 <img src="<?php echo xoousers_lite_url?>/admin/images/facebook.png" width="35" height="38" />
            <p class="day_amount"><?php echo $total_facebook?></p>
                  ...
                  <div class="statblock-social user-ultra-rounded">
                   ...
                   <h3 >Yahoo</h3>
                   <img src="<?php echo xoousers_lite_url?>/admin/images/yahoo.png" width="35" height="38" />
                  ...
                  <h3 >LinkedIn</h3>
                  <img src="<?php echo xoousers_lite_url?>/admin/images/linkedin.png" width="35" height="38" />
                 ...
                 <div class="statblock-social user-ultra-rounded">
                  ...
                  <h3 >Google</h3>
                  <img src="<?php echo xoousers_lite_url?>/admin/images/google.png" width="35" height="38" />
                  ...
                  <h3 >Twitter</h3>
                  <img src="<?php echo xoousers_lite_url?>/admin/images/twitter.png" width="35" height="38" />

...
<span id="loading-animation"> <img src="<?php echo xoousers_lite_url?>admin/images/loaderB16.gif" width="16" height="16" /></span>&nbsp;<a href="#uultra-add-field-btn" class="button button-primary "  id="uultradmin-confirm-rearrange"><i

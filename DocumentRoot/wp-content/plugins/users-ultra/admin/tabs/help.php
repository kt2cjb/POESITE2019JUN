...
?>
 ...
 <div class="user-ultra-sect ">
        ...
        <p>If you like this plugin, please don't forget to rate it <img src="<?php echo xoousers_lite_url?>/admin/images/star-rating.png" width="20" height="20" /><img src="<?php echo xoousers_lite_url?>/admin/images/star-rating.png" width="20" height="20" /><img src="<?php echo xoousers_lite_url?>/admin/images/star-rating.png" width="20" height="20" /><img src="<?php echo xoousers_lite_url?>/admin/images/star-rating.png" width="20" height="20" /><img src="<?php echo xoousers_lite_url?>/admin/images/star-rating.png" width="20" height="20" />. <?php _e("<a href='http://wordpress.org/plugins/users-ultra/' target='_blank'>CLICK HERE TO RATE IT </a>",'xoousers'); ?></p>

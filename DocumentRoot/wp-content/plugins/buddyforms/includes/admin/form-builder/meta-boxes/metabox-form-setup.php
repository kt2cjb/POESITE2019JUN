...
function buddyforms_metabox_form_setup()
{
    ...
    $form_setup['Form Submission'][] = $element;
    $element = new Element_Checkbox(
        '<b>' . __( 'Validate using JS', 'buddyforms' ) . '</b>',
        "buddyforms_options[js_validation]",
        array(
        'enabled' => __( 'Enable JavaScript Validation', 'buddyforms' ),
    ),
        array(
    ...
    $form_setup['Create Content'][] = $element;
    $element = new Element_Checkbox(
        '<b>' . __( 'Enable Draft', 'buddyforms' ) . '</b>',
        "buddyforms_options[draft_action]",
        array(
        'Enable Draft' => __( 'Enable Draft Form Action', 'buddyforms' ),
    ),
        array(
        'value' => $draft_action,
        'class' => 'bf_hide_if_post_type_none',

    ...
    switch ( sanitize_title( $field_type ) ) {
        case 'text':
            ...
            $form_fields['validation']['validation_minlength'] = new Element_Number( '<b>' . __( 'Validation Min Length', 'buddyforms' ) . '</b>', "buddyforms_options[form_fields][" . $field_id . "][validation_minlength]", array(
                ...
                'onchange' => 'validateRule("' . $field_id . '","min",this,"text")',
            ) );
            ...
            $form_fields['validation']['validation_maxlength'] = new Element_Number( '<b>' . __( 'Validation Max Length', 'buddyforms' ) . '</b>', "buddyforms_options[form_fields][" . $field_id . "][validation_maxlength]", array(
                ...
                'onchange' => 'validateRule("' . $field_id . '","max",this,"text")',
            ) );
            break;
        case 'country':
            break;
        ...
        case 'subject':
            ...
            $form_fields['validation']['validation_minlength'] = new Element_Number( '<b>' . __( 'Validation Min Length', 'buddyforms' ) . '</b>', "buddyforms_options[form_fields][" . $field_id . "][validation_minlength]", array(
                ...
                'min'      => 0,
                'field_id' => $field_id . '_validation_minlength',
                'onchange' => 'validateRule("' . $field_id . '","min",this,"subject")',
            ) );
            $validation_maxlength = ( isset( $customfield['validation_maxlength'] ) ? stripcslashes( $customfield['validation_maxlength'] ) : 0 );
            $form_fields['validation']['validation_maxlength'] = new Element_Number( '<b>' . __( 'Validation Max Length', 'buddyforms' ) . '</b>', "buddyforms_options[form_fields][" . $field_id . "][validation_maxlength]", array(
                'value'    => $validation_maxlength,
                'min'      => 0,
                'field_id' => $field_id . '_validation_maxlength',
                'onchange' => 'validateRule("' . $field_id . '","max",this,"subject")',
            ) );
            break;
        case 'message':
            unset( $form_fields['advanced']['slug'] );
            ...
            $form_fields['validation']['validation_minlength'] = new Element_Number( '<b>' . __( 'Validation Min Length', 'buddyforms' ) . '</b>', "buddyforms_options[form_fields][" . $field_id . "][validation_minlength]", array(
                ...
                'min'      => 0,
                'field_id' => $field_id . '_validation_minlength',
                'onchange' => 'validateRule("' . $field_id . '","min",this,"message")',
            ) );
            $validation_maxlength = ( isset( $customfield['validation_maxlength'] ) ? stripcslashes( $customfield['validation_maxlength'] ) : 0 );
            $form_fields['validation']['validation_maxlength'] = new Element_Number( '<b>' . __( 'Validation Max Length', 'buddyforms' ) . '</b>', "buddyforms_options[form_fields][" . $field_id . "][validation_maxlength]", array(
                'value'    => $validation_maxlength,
                'min'      => 0,
                'field_id' => $field_id . '_validation_maxlength',
                'onchange' => 'validateRule("' . $field_id . '","max",this,"message")',
            ) );
            break;
        case 'user_login':
            unset( $form_fields['advanced']['slug'] );
            ...
            $form_fields['general']['hide_if_logged_in'] = new Element_Checkbox(
                '<b>' . __( 'Hide Username Form Element for LoggedIn User', 'buddyforms' ) . '</b>',
        ...
        case 'user_email':
            ...
            $hide_if_logged_in = ( isset( $customfield['hide_if_logged_in'] ) ? $customfield['hide_if_logged_in'] : 'show' );
            $form_fields['general']['hide_if_logged_in'] = new Element_Checkbox(
                '<b>' . __( 'Hide User eMail Form Element for LoggedIn User', 'buddyforms' ) . '</b>',
                "buddyforms_options[form_fields][" . $field_id . "][hide_if_logged_in]",
                array(
                'hide' => '<b>' . __( 'Hide for logged in user', 'buddyforms' ) . '</b>',
            ),
        ...
        case 'textarea':
            ...
            $form_fields['validation']['validation_minlength'] = new Element_Number( '<b>' . __( 'Validation Min Length', 'buddyforms' ) . '</b>', "buddyforms_options[form_fields][" . $field_id . "][validation_minlength]", array(
                ...
                'field_id' => $field_id . '_validation_minlength',
                'onchange' => 'validateRule("' . $field_id . '","min",this,"textarea")',
            ) );
            $validation_maxlength = ( isset( $customfield['validation_maxlength'] ) ? stripcslashes( $customfield['validation_maxlength'] ) : 0 );
            $form_fields['validation']['validation_maxlength'] = new Element_Number( '<b>' . __( 'Validation Max Length', 'buddyforms' ) . '</b>', "buddyforms_options[form_fields][" . $field_id . "][validation_maxlength]", array(
                'value'    => $validation_maxlength,
                ...
                'field_id' => $field_id . '_validation_maxlength',
                'onchange' => 'validateRule("' . $field_id . '","max",this,"textarea")',
            ) );
        ...
        case 'post_excerpt':
            ...
            $form_fields['validation']['validation_minlength'] = new Element_Number( '<b>' . __( 'Validation Min Length', 'buddyforms' ) . '</b>', "buddyforms_options[form_fields][" . $field_id . "][validation_minlength]", array(
                ...
                'min'      => 0,
                'field_id' => $field_id . '_validation_minlength',
                'onchange' => 'validateRule("' . $field_id . '","min",this,"post_excerpt")',
            ) );
            $validation_maxlength = ( isset( $customfield['validation_maxlength'] ) ? stripcslashes( $customfield['validation_maxlength'] ) : 0 );
            $form_fields['validation']['validation_maxlength'] = new Element_Number( '<b>' . __( 'Validation Max Length', 'buddyforms' ) . '</b>', "buddyforms_options[form_fields][" . $field_id . "][validation_maxlength]", array(
                'value'    => $validation_maxlength,
                'min'      => 0,
                'field_id' => $field_id . '_validation_maxlength',
                'onchange' => 'validateRule("' . $field_id . '","max",this,"post_excerpt")',
            ) );
            $hidden = ( isset( $customfield['hidden_field'] ) ? $customfield['hidden_field'] : false );
            $form_fields['advanced']['hidden_field'] = new Element_Checkbox(
                '<b>' . __( 'Hidden?', 'buddyforms' ) . '</b>',
        ...
        case 'number':
            ...
            $form_fields['validation']['validation_min'] = new Element_Number( '<b>' . __( 'Validation Min Value', 'buddyforms' ) . '</b>', "buddyforms_options[form_fields][" . $field_id . "][validation_min]", array(
                ...
                'min'      => 0,
                'field_id' => $field_id . '_validation_minlength',
                'onchange' => 'validateRule("' . $field_id . '","min",this,"number")',
            ) );
            ...
            $form_fields['validation']['validation_max'] = new Element_Number( '<b>' . __( 'Validation Max Value', 'buddyforms' ) . '</b>', "buddyforms_options[form_fields][" . $field_id . "][validation_max]", array(
                ...
                'min'      => 0,
                'field_id' => $field_id . '_validation_maxlength',
                'onchange' => 'validateRule("' . $field_id . '","max",this,"number")',
            ) );
            break;
        case 'dropdown':
        ...
        case 'date':
            ...
            $form_fields['general']['enable_date'] = new Element_Checkbox(
                '<b>' . __( 'Enable Date', 'buddyforms' ) . '</b>',
                "buddyforms_options[form_fields][" . $field_id . "][enable_date]",
                array(
                'enable_date' => '<b>' . __( 'Include the Date Picker in the element', 'buddyforms' ) . '</b>',
            ),
                array(
                'value' => $enable_date,
            )
            ...
            $form_fields['general']['is_inline'] = new Element_Checkbox(
                '<b>' . __( 'Is inline', 'buddyforms' ) . '</b>',
                "buddyforms_options[form_fields][" . $field_id . "][is_inline]",
                array(
                'is_inline' => '<b>' . __( 'Show the element inline', 'buddyforms' ) . '</b>',
            ),
                array(
                'value' => $is_inline,
            )
            ...
            $form_fields['general']['element_save_format'] = new Element_Textbox( '<b>' . __( 'Save Format', 'buddyforms' ) . '</b>', "buddyforms_options[form_fields][" . $field_id . "][element_save_format]", array(
                'value' => $element_save_format,
            ) );
            break;
        case 'post_formats':
            unset( $form_fields['advanced']['slug'] );
...
JS;
        ...
        case 'title':
            ...
            $form_fields['validation']['validation_minlength'] = new Element_Number( '<b>' . __( 'Validation Min Length', 'buddyforms' ) . '</b>', "buddyforms_options[form_fields][" . $field_id . "][validation_minlength]", array(
                ...
                'min'      => 0,
                'field_id' => $field_id . '_validation_minlength',
                'onchange' => 'validateRule("' . $field_id . '","min",this,"title")',
            ) );
            ...
            $form_fields['validation']['validation_maxlength'] = new Element_Number( '<b>' . __( 'Validation Max Length', 'buddyforms' ) . '</b>', "buddyforms_options[form_fields][" . $field_id . "][validation_maxlength]", array(
                ...
                'min'      => 0,
                'field_id' => $field_id . '_validation_maxlength',
                'onchange' => 'validateRule("' . $field_id . '","max",this,"title")',
            ) );
            $hidden = ( isset( $customfield['hidden_field'] ) ? $customfield['hidden_field'] : false );
            $form_fields['advanced']['hidden_field'] = new Element_Checkbox(
                '<b>' . __( 'Hidden?', 'buddyforms' ) . '</b>',
        ...
        case 'content':
            ...
            $form_fields['validation']['validation_minlength'] = new Element_Number( '<b>' . __( 'Validation Min Length', 'buddyforms' ) . '</b>', "buddyforms_options[form_fields][" . $field_id . "][validation_minlength]", array(
                ...
                'min'      => 0,
                'field_id' => $field_id . '_validation_minlength',
                'onchange' => 'validateRule("' . $field_id . '","min",this,"content")',
            ) );
            $validation_maxlength = ( isset( $customfield['validation_maxlength'] ) ? stripcslashes( $customfield['validation_maxlength'] ) : 0 );
            $form_fields['validation']['validation_maxlength'] = new Element_Number( '<b>' . __( 'Validation Max Length', 'buddyforms' ) . '</b>', "buddyforms_options[form_fields][" . $field_id . "][validation_maxlength]", array(
                'value'    => $validation_maxlength,
                'min'      => 0,
                'field_id' => $field_id . '_validation_maxlength',
                'onchange' => 'validateRule("' . $field_id . '","max",this,"content")',
            ) );
            $hidden = ( isset( $customfield['hidden_field'] ) ? $customfield['hidden_field'] : false );
            $form_fields['advanced']['hidden_field'] = new Element_Checkbox(
                '<b>' . __( 'Hidden?', 'buddyforms' ) . '</b>',
        ...
        case 'form_actions':
            ...
            $form_fields['general']['enable_draft'] = new Element_Checkbox(
                '<b>' . __( 'Draft Button', 'buddyforms' ) . '</b>',
                "buddyforms_options[form_fields][" . $field_id . "][enable_draft]",
                array(
                'enable_draft' => '<b>' . __( 'Check to enabled', 'buddyforms' ) . '</b>',
            ),
                array(
            ...
            $form_fields['general']['enable_publish'] = new Element_Checkbox(
                '<b>' . __( 'Publish Button', 'buddyforms' ) . '</b>',
                "buddyforms_options[form_fields][" . $field_id . "][enable_publish]",
                array(
                'enable_publish' => '<b>' . __( 'Check to enabled', 'buddyforms' ) . '</b>',
            ),
                array(
    ...
    ?></a>
                        ...
                        <td class="field_name">
                            <div class="tooltip">
                                <span class="field_name_text bf-ready-to-copy"><?php 
    echo  $field_slug ;
    ?></span>
                                <span class="tooltip-container"><?php 
    _e( 'Copy to clipboard', 'buddyforms' );
    ?></span>
                            </div>
                        </td>
    ...
    echo  $field_id ;
    ?>" title="<?php 
    _e( 'Delete this Field', 'buddyforms' );
    ?>"
                                     href="#"><?php 
    _e( 'Delete', 'buddyforms' );
    ?></a></span>
                        </td>

...
class Instagram implements ExperimentsInterface
{
        ...
        $sessionid = null)
    {
        ...
        return $this->_login($username, $password, false, $appRefreshInterval, $sessionid);
    }
        ...
        $sessionid)
    {
        ...
        if ($this->username !== $username || $this->password !== $password) {
            $this->_setUser($username, $password, $sessionid);
        }
        ...
        $sessionid)
    {
        ...
        if (1){//empty($this->settings->get('session_id'))) {
            //$this->settings->set('session_id', Signatures::generateUUID(true));
            //$this->settings->set('session_id', $sessionid);
            $this->settings->set('session_id', 'IGSCefac4f7fc42a4ea920a4af415265b00fac562d7168541fd153170b3021cb6a8e%3AnplqHxmhvLDymYO3XvCiNNIPDDOONCOw%3A%7B%22_auth_user_id%22%3A5395215915%2C%22_auth_user_backend%22%3A%22accounts.backends.CaseInsensitiveModelBackend%22%2C%22_auth_user_hash%22%3A%22%22%2C%22_platform%22%3A4%2C%22_token_ver%22%3A2%2C%22_token%22%3A%225395215915%3AhmWiiZ3Dwg1ZqCANJoR7a9HG5ieEjAL7%3A6b5bce534d5c3982a85bdda855ded687d1ec01d89eac3d353d687252ba8f76ec%22%2C%22last_refreshed%22%3A1538949906.8402752876%7D');
        }

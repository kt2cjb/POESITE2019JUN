...
?>
          <div class="tag-contents">
            ...
            <div class="tag__child">
              ...
              <input class="tag__child--item" type="checkbox" name="checkbox" value="<?php echo $childCategory->slug; ?>" id="<?php echo $childCategory->slug; ?>" <?php if($thisTerm == $childCategory->slug){ echo 'checked'; } ?>/>
